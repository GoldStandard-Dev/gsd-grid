...
const styles = StyleSheet.create({
  ...
  statValue: { fontSize: 26, fontWeight: "900", color: "#ffffff", marginTop: 4 },
  ...
  quickBtnGold: { backgroundColor: GOLD, borderColor: GOLD_DARK, shadowColor: GOLD, shadowOpacity: 0.3, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 3 },
  ...
  woClient: { fontSize: 12, fontWeight: "700", color: MUTED, marginTop: 2 },
  woArrow: { marginTop: 4 },
